...
public class BookData {
    ...
    public static List<Book> getBooks() {
        ...
        books.add(new Book(
                R.drawable.img_bookcover_animalfarm,
                "Animal Farm",
                "George Orwell",
                "Fiction",
        ...
        books.add(new Book(
                R.drawable.img_bookcover_thealchemist,
                "The Alchemist",
                "Paulo Coelho",
                "Fiction",
        ...
        books.add(new Book(
                R.drawable.img_bookcover_lemon,
        ...
        books.add(new Book(
                R.drawable.img_bookcover_quiet,
        ...
        books.add(new Book(
                R.drawable.img_bookcover_makebelieve,
                "Make Believe",
                "Mac Barnett",
                "Non-Fiction",
        ...
        books.add(new Book(
                R.drawable.img_bookcover_atomichabits,
